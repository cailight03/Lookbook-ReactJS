...
import logo3 from '../icons/henkel-logo.png'; 

const ReviewFooter = () => {
  return (
    <Box sx={{ backgroundColor: '#BDCDDA', p: 4 }}>
      <Container>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Box mt={2}>
              <Box display="flex" alignItems="center" mb={1} mt={4}>
                <Email sx={{ mr: 1, color: '#E1000F' }} />
                <Typography color="#E1000F" sx={{fontFamily: "'Montserrat', sans-serif", fontSize: '.9rem', fontWeight: 'medium',}}>
                  contact@henkel.com
                </Typography>
              </Box>
              <Box display="flex" alignItems="center" mb={1}>
                <LocationOn sx={{ mr: 1, color: '#E1000F' }} />
                <Typography color="#E1000F" sx={{fontFamily: "'Montserrat', sans-serif", fontSize: '.9rem', fontWeight: 'medium',}}>
